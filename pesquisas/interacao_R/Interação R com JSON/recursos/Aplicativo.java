...
public class Aplicativo {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //objeto criado para receber os valores que comporao a arraylist
        ...
        System.out.println("\nSeja bem vindo(a) ao sistema de calculo da mediana!!!");
        System.out.println("\nInforme os valores desejado, para iniciar a execucao aperte ENTER no espaco vazio\n");
        while(continuar){
            valor = entrada.nextLine();
            //condicional necessaria para verificar se o valor e vazio
            if(valor.isEmpty())
                break;
        ...
        try{
            ...
            //informa que dados deverao ser gravados no arquivo
        ...
        //identifica qual o nome do sistema operacional executado na maquina
